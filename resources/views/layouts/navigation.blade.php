            ...
            @auth
                ...
                <div class="relative inline-block text-left" x-data="{ open: false }">
                    ...
                    <button @click="open = !open" class="flex items-center space-x-2 focus:outline-none">
                        <img src="{{ Auth::user()->profile_picture ? asset('storage/' . Auth::user()->profile_picture) : url('/images/default-avatar.png') }}" 
                             alt="Profile Picture" class="w-10 h-10 rounded-full border border-gray-300 object-cover">
